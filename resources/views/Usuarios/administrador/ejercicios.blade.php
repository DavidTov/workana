...
<div class="page-wrapper">
  ...
  <div class="page-header card">
    ...
    <div class="card-block icon-btn">
      <a href="#ventana4" data-toggle="modal"><button class="btn btn-success btn-outline-success btn-icon"><i class="icofont icofont-plus"></i></button></a>
    </div>
  </div>
</div>
                      ...
                      <tr>
                          ...
                          <td rowspan="1" colspan="1">
                            <form action="/Administrador/Ejercicio/Borrar/{{$dato->id}}" method="POST">
                              {{csrf_field()}}
                              <button class="btn btn-danger" type="submit"><i class="icofont icofont-bin"></i></button>
                            </form>
                          </td>
                      </tr>
                    @endforeach
