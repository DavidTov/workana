      ...
      <div class="row">
        ...
        <div class="col-6 col-md">
          ...
          <ul class="list-unstyled text-small">
            <li><a class="text-muted" href="#">Jovenes emprendedores</a></li>
            <li><a class="text-muted" href="#">Equipo de jovenes dedicados</a></li>
            <li><a class="text-muted" href="#">al desarrollo.</a></li>
        ...
        <div class="col-6 col-md">
          <h5>Recursos</h5>
          <ul class="list-unstyled text-small">
            <li><a class="text-muted" href="#">Ganas de emprender</a></li>
            <li><a class="text-muted" href="#">Computadores</a></li>
            <li><a class="text-muted" href="#">Habilidades de programación</a></li>
        ...
        <div class="col-6 col-md">
          ...
          <ul class="list-unstyled text-small">
            ...
            <li><a class="text-muted" href="#">Niños</a></li>
          </ul>
        </div>
        <div class="col-6 col-md">
          <h5>Acerca de </h5>
          <ul class="list-unstyled text-small">
            ...
            <li><a class="text-muted" href="#">Lugar fisico</a></li>
